...
mod tests {
    ...
    fn ngram_language_from_str() {
        ...
        assert_eq!(NgramLanguage::parse("en"), Some(NgramLanguage::English));
        assert_eq!(NgramLanguage::parse("french"), Some(NgramLanguage::French));
        assert_eq!(NgramLanguage::parse("fr"), Some(NgramLanguage::French));
        assert_eq!(NgramLanguage::parse("german"), Some(NgramLanguage::German));
        assert_eq!(NgramLanguage::parse("de"), Some(NgramLanguage::German));
        assert_eq!(NgramLanguage::parse("unknown"), None);
    }
