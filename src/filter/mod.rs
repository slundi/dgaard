...
pub fn parse_line<'a, F>(line: &'a str, parser: F) -> Result<(u64, String), ListError<'a>>
where
    F: Fn(&'a str) -> Result<(u64, String), ListError<'a>>,
{
...
pub fn parse_host_line(line: &str) -> Result<(u64, String), ListError<'_>> {
    ...
    Ok((hash, domain.to_string()))
}

// Example with (ex: dnsmasq format "address=/doubleclick.net/127.0.0.1")
pub fn parse_dnsmasq_line(line: &str) -> Result<(u64, String), ListError<'_>> {
